...
<%
    ...
    if (userIdStr != null) {
        ...
        List<Map<String, Object>> historyWithDetails = new ArrayList<Map<String, Object>>();
        for (BookIssue issue : userHistory) {
            ...
            if (book != null) {
                ...
                historyWithDetails.add(bookIssue);
            }
        }
        
        request.setAttribute("history", historyWithDetails);
    }
%>
    ...
    <div class="container-fluid">
        <div class="row">
            <nav class="col-md-3 col-lg-2 d-md-block sidebar collapse">
                <div class="position-sticky pt-3">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item"><a class="nav-link text-white active" href="${pageContext.request.contextPath}/student/history.jsp"><i class="fas fa-history"></i> Borrowing History</a></li>
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="pt-3 pb-2 mb-3 border-bottom"><h1 class="h2">Borrowing History</h1></div>
                <div class="card">
                    <div class="card-body">
                        <table class="table table-striped">
                            <thead><tr><th>Book</th><th>Issue Date</th><th>Due Date</th><th>Return Date</th><th>Status</th></tr></thead>
                            <tbody>
                                <c:forEach var="bookIssue" items="${history}">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <c:choose>
                                                <c:when test="${issue.status == 'RETURNED'}"><span class="badge bg-success">Returned</span></c:when>
                                                <c:when test="${issue.status == 'ISSUED'}"><span class="badge bg-primary">Issued</span></c:when>
